...
/// particulars GeoGuard can attest to from its own records. It is not, on its
...
class CertificateService {
  ...
  Future<Uint8List> build({
    ...
    final pw.Document doc = pw.Document(
      title: 'GeoGuard evidence certificate',
      author: 'GeoGuard',
    );
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        footer: (pw.Context c) => pw.Container(
          ...
          child: pw.Text(
            'GeoGuard evidence certificate  ·  page ${c.pageNumber} of '
            '${c.pagesCount}',
        ...
        build: (pw.Context c) => <pw.Widget>[
          ...
          pw.SizedBox(height: 14),
          pw.Text(
            'Draft generated by GeoGuard on ${_stamp.format(now)}. Unsigned, '
  ...
  List<List<String>> _recordRows(
    ...
    if (e == null) {
      rows.add(<String>['Status', 'No GeoGuard payload present in this file']);
      return rows;
    }
  ...
  String _mannerOfProduction() =>
      'The photograph was captured by the GeoGuard application running on the '
